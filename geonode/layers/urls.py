...
urlpatterns = patterns(
    ...
    url(r'^land_cover$', 'land_cover', name='land_cover'),
    url(r'^vulnerability_assessment$', 'vulnerability_assessment', name='vulnerability_assessment'),
    url(r'^rs_products$', 'rs_products', name='rs_products'),
    ...
    url(r'^(?P<layername>[^/]*)/layer_tracker/(?P<dl_type>[^/]*)/', 'layer_tracker', name='layer_tracker'),
