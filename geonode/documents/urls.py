...
urlpatterns = patterns('geonode.documents.views',
                        # url(r'^$', TemplateView.as_view(template_name='documents/document_list.html'), name='document_browse'),
                        url(r'^$', 'document_list', name='document_browse'),
                        url(r'^list/(?P<maptype>[^/]*)$', 'document_browse', name='document_browse'),
